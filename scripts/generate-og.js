...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
  ...
  <text x="60" y="245" font-size="18" font-weight="500" fill="${MUTED}">매주 월요일 자동 갱신 · inno-hi.github.io/weeklaude</text>
  ...
  <text x="${1200 - 60}" y="${630 - 30}" font-size="12" font-weight="600" fill="${ACCENT}" text-anchor="end">★ Star on GitHub: INNO-HI/weeklaude</text>
</svg>`;
}
